...
class R5BetaHardwareToolTests(unittest.TestCase):
    ...
    def test_r5e_identity_is_exact(self):
        self.assertEqual(r5_beta_hw.EXPECTED_FIRMWARE, 0x0515)
    ...
    def test_read_state_rejects_legacy_identity_and_requires_signature(self):
        class Client:
            def __init__(self, firmware=0x0515, signature=0x55B5):
            ...
            def read(self, address, quantity):
                ...
                return values, None
        self.assertEqual(r5_beta_hw.read_state(Client())["firmware"], "0x0515")
    ...
    def test_record_preserves_rows_on_interrupt(self):
        class Transport:
            ...
            def close(self): pass
        base = {"utc":"2026-09-16T00:00:00.000Z","firmware":"0x0515",
