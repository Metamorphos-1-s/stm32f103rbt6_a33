...
| 封面/附录 E | Firmware reported value `0x050E` | `Config/project_config.h`、`Docs/BLE_PROTOCOL_V1.md` | Current software value; historical records through 0x050D remain unchanged |
