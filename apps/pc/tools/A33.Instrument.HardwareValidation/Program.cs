...
await using var service=new InstrumentMonitoringService();var stopwatch=Stopwatch.StartNew();double maxStaleMs=0;var samples=0;string status="PASS";string? failure=null;
try
{
